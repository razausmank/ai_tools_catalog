...
<div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"
    ...
    <h4 class="d-flex flex-center rounded-top">
        ...
        <span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2">{{ $messages_count }}
            new</span>
    </h4>
    ...
    <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8"
        role="tablist">
        <li class="nav-item">
            <a class="nav-link active show" data-toggle="tab" href="#topbar_notifications_notifications">Messages</a>
        </li>
        {{-- <li class="nav-item">
...
<div class="tab-content">
    ...
    <div class="tab-pane active show " id=" topbar_notifications_notifications" role="tabpanel">
        @if ($messages_count)
            <div class="navi navi-hover scroll my-4" data-scroll="true" data-height="200" data-mobile-height="150">
                ...
                @foreach ($messages as $message)
                    ...
                    <a href="{{ route('contactus.show', $message->notifiable_id) }}" class="navi-item">
                        <div class="navi-link">
                            ...
                            <div class="navi-text">
                                <div class="font-weight-bold">
                                    New message from {{ $message->data['name'] }}
                                </div>
        ...
        <div class="d-flex flex-center py-7">
            <a href="{{ route('contactus.index') }}" class="btn btn-light-primary font-weight-bold text-center">See
                All</a>
        </div>
    </div>
